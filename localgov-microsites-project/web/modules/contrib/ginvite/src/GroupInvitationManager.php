...
class GroupInvitationManager {
  ...
  public function __construct(EntityTypeManagerInterface $entity_type_manager) {
    ...
    $this->groupRelationTypeStorage = $this->entityTypeManager->getStorage('group_relationship_type');
  }
  ...
  public function createInvitation(GroupInterface $group, $email = NULL, $user_id = 0, array $group_roles = []) {
    ...
    if (!empty($group_roles)) {
      ...
      foreach ($group_roles as $group_role) {
        ...
        $group_relationship_roles[] = ['target_id' => $group_role];
      }
    }
    ...
    return GroupRelationship::create([
      ...
      'entity_id' => $user_id,
      'invitee_mail' => $email,
      'group_roles' => $group_relationship_roles,
      'plugin_id' => $plugin_id,
    ]);
  }
