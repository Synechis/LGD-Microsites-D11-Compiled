  ...
  private function validateExistingMembers(array $invitees) {
    ...
    foreach ($invitees as $line => $invitee) {
      if ($user = user_load_by_mail($invitee)) {
        $membership = GroupMembership::loadSingle($this->group, $user);
    ...
    if (!empty($invalid_emails)) {
      $message_singular = 'User with @error_message email is already a member of this group.<br />';
      $message_plural = 'Users with: @error_message emails are already members of this group.<br />';
