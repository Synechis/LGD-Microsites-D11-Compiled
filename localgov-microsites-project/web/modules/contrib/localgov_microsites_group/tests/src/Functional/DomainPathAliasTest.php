...
class DomainPathAliasTest extends BrowserTestBase {
  ...
  public function testDomainPathAlias() {
    ...
    $this->assertSession()->addressEquals(Url::fromUri('internal:/test-page')->toString());
    ...
    $this->assertSession()->addressEquals(Url::fromUri('internal:/test-page2')->toString());
    ...
    $this->assertSession()->addressEquals(Url::fromUri('internal:/test-page3')->toString());
  }
