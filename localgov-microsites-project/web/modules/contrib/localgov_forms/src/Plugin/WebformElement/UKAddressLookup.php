...
use Drupal\localgov_forms\Geocoders;
...
class UKAddressLookup extends WebformCompositeBase {
  ...
  /**
   * The geocoder selection service.
   *
   * @var \Drupal\localgov_forms\Geocoders
   */
  protected Geocoders $geocoderSelection;
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    ...
    $instance->geocoderSelection = $container->get('localgov_forms.geocoder_selection');
    return $instance;
  }
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $parent_form['element']['geocoder_plugins'] = [
      ...
      '#options'  => $this->geocoderSelection->listInstalledPluginNames(),
      '#required' => TRUE,
