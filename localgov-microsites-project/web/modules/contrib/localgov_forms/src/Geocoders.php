...
class Geocoders {
  ...
  public function getSelectedPlugins(array $selected_plugin_ids) :array {
    ...
    $selected_n_available_plugin_instances = $this->entityTypeManager->getStorage('geocoder_provider')->loadMultiple($selected_n_available_plugin_ids);
  ...
  public function listInstalledPluginNames() :array {
    ...
    $installed_geocoders = $this->entityTypeManager->getStorage('geocoder_provider')->loadMultiple();
   ...
   *   The Entity type manager is needed to load geocoder_provider entities.
   */
