...
class DomainSourceEntityReferenceTest extends DomainTestBase {
  ...
  public function testDomainSourceFieldStorage() {
    ...
    // The active domain must be renegotiated after domain creation, as it was
    // initially negotiated before the domains were available.
    $negotiator = \Drupal::service('domain.negotiator');
    // Reset is required here as the canNegotiate flag was formerly set to FALSE
    // when we tried negotiating without any available domains.
    $active_domain = $negotiator->getActiveDomain(TRUE);
